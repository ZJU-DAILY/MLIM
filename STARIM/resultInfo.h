...
{
private:
	double __RunningTime = -1.0, __Influence = -1.0, __InfluenceOriginal = -1.0, __InfluenceMC = -1.0, __Approx = -1.0;
	int __SeedSize = 0;
...
public:
	...
	double get_influence_MC() const
	{
		return __InfluenceMC;
	}
	...
	void set_influence_MC(const double value)
	{
		__InfluenceMC = value;
	}
	...
	/// Set seed sets.
	void set_seed_vec(const Nodelist& vecSeed)
	{
		__VecSeed = vecSeed;
	...
	/// Set the recurrence round
	void set_round(const size_t value)
	{
		__round = value;
	}
};
